...
namespace EventHub.DataAccess.Migrations
{
    ...
    [Migration("20250218144553_FixRoleInitial")]
    partial class FixRoleInitial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventHub.Models.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EventHub.Models.UserAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EventHub.Models.User", b =>
                {
                    b.HasOne("EventHub.Models.UserAddress", "UserAddress")
                        .WithOne("User")
                        .HasForeignKey("EventHub.Models.User", "UserAddressId");
